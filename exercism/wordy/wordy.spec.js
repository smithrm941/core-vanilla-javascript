...
describe('Word Problem', function() {
  ...
  it('add twice', function() {
    ...
    expect(WordProblem(question)).toEqual(3);
  });

  it('add then subtract', function() {
    var question = 'What is 1 plus 5 minus -2?';
    expect(WordProblem(question)).toEqual(8);
  });
